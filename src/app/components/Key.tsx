    ...
    return (
        <div className="space-y-4">
            ...
            <div className="text-center">
                <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-6 px-6 py-4 bg-gray-800/30 backdrop-blur-sm rounded-lg border border-gray-700/50">
